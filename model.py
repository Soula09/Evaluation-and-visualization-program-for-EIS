...
class Datum():
	def __init__(self, name, data):
		...
		self.processed_data_linkk = None
		self.expt_type = None
		...
		self.hfr_linkk = None
		self.hfrlinkk_total = None
		self.curr_density = None 
		self.frequency_hfr = None
		self.frequency_hfr_frequency = None
		self.hfr_twopts = None 
		self.hfr_area = None
		self.randle = None 
		self.mu = None 
		self.rmse = None 
		self.previous_initial_guess = None
	...
	def get_processed_data_linkk(self):
		if self.processed_data_linkk is not None:
			return self.processed_data_linkk.copy()
		return None	
	...
	def get_negative_imaginary(self):
		return self.negative_imaginary
	...
	def get_hfr_linkk(self):
		return self.hfr_linkk

	def get_hfrlinkk_total(self):
		return self.hfrlinkk_total

	def get_curr_density(self):
		return self.curr_density

	def get_hfr_twopts(self):
		return self.hfr_twopts

	def get_hfr_area(self):
		return self.hfr_area

	def get_frequency_hfr(self):
		return self.frequency_hfr

	def get_frequency_hfr_frequency(self):
		return self.frequency_hfr_frequency
	...
	def set_processed_data_linkk(self, new_data):
		self.processed_data_linkk = new_data

	def set_expt_type(self, new_type):
		self.expt_type = new_type.lower()

	def set_current_data(self, new_vals):
		self.current_data = new_vals

	def set_potential_data(self, new_vals):
		self.potential_data = new_vals
	...
	def set_maxfreq(self, new_val):
		self.maxfreq = new_val
	...
	def set_hfr_linkk(self, new_val):
		self.hfr_linkk = new_val

	def set_hfrlinkk_total(self, new_val):
		self.hfrlinkk_total = new_val

	def set_curr_density(self, new_val):
		self.curr_density = new_val
	
	def set_hfr_twopts(self, new_val):
		self.hfr_twopts = new_val


	def set_hfr_area(self, new_val):
		self.hfr_area = new_val

	def set_frequency_hfr(self, new_val):
		self.frequency_hfr = new_val

	def set_frequency_hfr_frequency(self, new_val):
		self.frequency_hfr_frequency = new_val
